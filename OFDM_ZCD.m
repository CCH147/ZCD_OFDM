...
disp('======================================================');
disp('   ZCD 零點遷移與韋達還原 端到端模擬 (含通道衰減)');
disp('======================================================');
...
f0 = 20e3;              % 基頻 (20kHz)
M = 4;                  % 資料子載波數量 (M=4)
% 為了極度精準抓取過零點，我們需要非常高的取樣率 (模擬真實世界的類比連續訊號)
fs = 1000 * f0 * (M+1); 
...
% ========================================================
% 3. Channel: 真實空氣通道衰減 (Flat Fading)
% ========================================================
true_k = 0.35; % 假設空氣讓訊號振幅萎縮成原本的 35%
% (註: 此處以展示 ZCD 抗振幅衰減的物理特性為主)
...
% ========================================================
% 5. 核心演算法: 韋達定理還原 (Vieta Reconstruction)
% ========================================================
...
% (C) 比例校正 (Scaling)
% 這裡展現了抗衰減魔法！接收端只要除以展開後的首項，並乘回「已知的 TX 強載波」
...
fprintf('\n[解調結果] 透過韋達定理還原的符碼 (自動無視通道 0.35 衰減!):\n');
for k=1:M
...
title('時域波形與過零點 (注意: 衰減完全不影響過零點位置)');
